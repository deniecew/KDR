...
# jan25 <- read_excel("C:/Users/4477078/OneDrive - Moffitt Cancer Center/Key Drivers/kdr_serviceline/data/jan2025.xlsx")
# #
# # ##combine rows of data tables
# #
# op_data<-rbind(jul24, aug24, sep24, oct24, nov24, dec24,jan25)
# 
# op_data <- op_data%>%
#   clean_names() %>%
#   as.data.frame() %>%
...
#     survey_designator %in% c("ON0104E", "ON0101E" ) ~ "Clinic Provider",
#     survey_designator == "ON0102E" ~ "Infusion",
#     survey_designator == "ON0103E" ~ "Radiation Treatment",
#     is.na(survey_designator) ~ "Missing"
#   ) ) %>%
#   filter (service == params$service, na.rm = TRUE)
# 
...
data <- op_data %>%
  filter (survey_type == params$survey_type)
...
#### `r svcline_filter` -- `r params$survey_type` Survey
